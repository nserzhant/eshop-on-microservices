...
namespace R2S.EmployeeManagement.Core.IntegrationTests
{
    ...
    {
        protected IEmployeeService userService;
        protected EmployeeReadDbContext readDbContext;
        protected IEmployeeQueryService userQueryService;
        ...
        public override async Task Setup()
        {
            ...
            userService = serviceProvier.GetRequiredService<IEmployeeService>();
            readDbContext = serviceProvier.GetRequiredService<EmployeeReadDbContext>();
            userQueryService = serviceProvier.GetRequiredService<IEmployeeQueryService>();
        }
        ...
        public async Task When_User_Exists_Then_It_Could_Be_Requested_By_Email()
        {
            ...
            EmployeeReadModel user = await userQueryService.GetByEmail(userEmail);
